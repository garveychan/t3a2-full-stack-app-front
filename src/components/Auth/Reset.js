// Password reset page accessed via the unique link generated by Devise and sent via email.
// Immediately redirects to /reset for a clean URL and contains a controlled form similar to signup.
